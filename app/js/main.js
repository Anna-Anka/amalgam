  ...
  if (forms) {
    forms.forEach(function (form) {
      ...
      if (form.querySelector('input[type="email"]')) {
        ...
        allEmailFields.forEach(function (item) {
      ...
      if (form.querySelector('input[type="tel"]')) {
        var _allEmailFields = form.querySelectorAll('input[type="tel"]');
        _allEmailFields.forEach(function (item) {
          validation.addField(item, [{
            rule: 'customRegexp',
      ...
      if (form.querySelector('input[data-agreement]')) {
        var _allEmailFields2 = form.querySelectorAll('input[data-agreement]');
        _allEmailFields2.forEach(function (item) {
          validation.addField(item, [{
            rule: 'required'
          }]);
        });
...
window.BASE_MODAL = new graph_modal__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
new graph_modal__WEBPACK_IMPORTED_MODULE_0__["default"]('modal-form');
new graph_modal__WEBPACK_IMPORTED_MODULE_0__["default"]('modal-thank');
...
// https://www.npmjs.com/package/graph-tabs

if (document.querySelector('[data-tabs="realized-projects"]')) {
  new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('realized-projects');
}

/***/ }),

/***/ "./src/js/libs/_tippy.js":
/*!*******************************!*\
  !*** ./src/js/libs/_tippy.js ***!
  \*******************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var setTooltip = function setTooltip(attr, settings) {
  return (0,tippy_js__WEBPACK_IMPORTED_MODULE_0__["default"])(attr, settings ? settings : baseTippySettings);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tabs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_tabs.js */ "./src/js/libs/_tabs.js");
/* harmony import */ var _modals_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_modals.js */ "./src/js/libs/_modals.js");
/* harmony import */ var _tippy_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_tippy.js */ "./src/js/libs/_tippy.js");
/* harmony import */ var _just_validate_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_just-validate.js */ "./src/js/libs/_just-validate.js");
...
new smooth_scroll__WEBPACK_IMPORTED_MODULE_5__('a[data-scroll]');
_fancyapps_ui__WEBPACK_IMPORTED_MODULE_4__.Fancybox.bind();

/***/ }),

/***/ "./src/js/project/_animation-frame-buildings-images.js":
/*!*************************************************************!*\
  !*** ./src/js/project/_animation-frame-buildings-images.js ***!
  \*************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
(function () {
  var images = document.querySelectorAll('.frame-features .block-info__image');
  if (!images) {
    return null;
  }
...
__webpack_require__.r(__webpack_exports__);
(function () {
  var scrollTopButton = document.querySelector('.button-top');
  if (!scrollTopButton) {
    return;
  }
  var toggleScrollTopButton = function toggleScrollTopButton() {
...
/***/ "./src/js/project/_characteristics.js":
/*!********************************************!*\
  !*** ./src/js/project/_characteristics.js ***!
  \********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
(function () {
  var grid = document.querySelector('.characteristics');
  if (!grid) {
    return;
  }
  var items = grid.querySelectorAll('.characteristics__item');
  var columns = 3;
  var rows = Math.ceil(items.length / columns);
  grid.style.gridTemplateRows = "repeat(".concat(rows, ", auto)");
})();

/***/ }),

/***/ "./src/js/project/_cookie.js":
/*!***********************************!*\
  !*** ./src/js/project/_cookie.js ***!
  \***********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
(function () {
  ...
  var button = document.querySelector('.cookie__button');
  if (!cookie || !button) {
    return null;
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _slider_home_hero_slider_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slider/_home-hero-slider.js */ "./src/js/project/slider/_home-hero-slider.js");
/* harmony import */ var _slider_realized_projects_slider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./slider/_realized-projects-slider.js */ "./src/js/project/slider/_realized-projects-slider.js");
/* harmony import */ var _slider_documents_slider_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slider/_documents-slider.js */ "./src/js/project/slider/_documents-slider.js");
...
/* harmony import */ var _animation_frame_buildings_images_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./_animation-frame-buildings-images.js */ "./src/js/project/_animation-frame-buildings-images.js");
/* harmony import */ var _characteristics_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./_characteristics.js */ "./src/js/project/_characteristics.js");
/* harmony import */ var _button_top_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./_button-top.js */ "./src/js/project/_button-top.js");
/* harmony import */ var _cookie_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./_cookie.js */ "./src/js/project/_cookie.js");
...
/***/ "./src/js/project/slider/_brands-slider.js":
/*!*************************************************!*\
  !*** ./src/js/project/slider/_brands-slider.js ***!
  \*************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/project/slider/_documents-slider.js":
/*!****************************************************!*\
  !*** ./src/js/project/slider/_documents-slider.js ***!
  \****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var buttons = document.querySelectorAll('.documents__name');
if (document.querySelector('.documents__swiper')) {
  var documentsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.documents__swiper', {
    loop: true,
    speed: 800,
    slidesPerView: 3,
    spaceBetween: 20,
...
/***/ "./src/js/project/slider/_home-hero-slider.js":
/*!****************************************************!*\
  !*** ./src/js/project/slider/_home-hero-slider.js ***!
  \****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/project/slider/_image-slider.js":
/*!************************************************!*\
  !*** ./src/js/project/slider/_image-slider.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.image-slider__swiper')) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.image-slider__swiper', {
    loop: true,
    speed: 800,
    slidesPerGroup: 1,
    slidesPerView: 1,
...
if (document.querySelector('.planning-slider__swiper')) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.planning-slider__swiper', {
    loop: true,
    speed: 800,
    slidesPerGroup: 1,
    slidesPerView: 1,
...
/***/ "./src/js/project/slider/_realized-projects-slider.js":
/*!************************************************************!*\
  !*** ./src/js/project/slider/_realized-projects-slider.js ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.realized-projects__swiper')) {
  var allSwipers = document.querySelectorAll('.realized-projects__swiper');
...
/***/ "./src/js/project/slider/_reviews-slider.js":
/*!**************************************************!*\
  !*** ./src/js/project/slider/_reviews-slider.js ***!
  \**************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/templates/_get-header-height.js":
/*!************************************************!*\
  !*** ./src/js/templates/_get-header-height.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
(function () {
  ...
  var changeHeaderHeight = function changeHeaderHeight() {
    document.querySelector(':root').style.setProperty('--header-height', "".concat(header.offsetHeight, "px"));
  };
  changeHeaderHeight();
  var changeHeaderHeightThrottle = (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(changeHeaderHeight);
  window.addEventListener('resize', changeHeaderHeightThrottle);
})();

/***/ }),

/***/ "./src/js/templates/_set-dvh.js":
/*!**************************************!*\
  !*** ./src/js/templates/_set-dvh.js ***!
  \**************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
(function () {
  function setDynamicHeight() {
    var vh = window.innerHeight * 0.01; // 1% от высоты окна
    document.documentElement.style.setProperty('--dvh', "".concat(vh, "px"));
  }
  setDynamicHeight();
  var setDynamicHeightThrottle = (0,_utils_throttle_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(setDynamicHeight);
...
/* harmony import */ var _get_header_height_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_get-header-height.js */ "./src/js/templates/_get-header-height.js");
/* harmony import */ var _set_dvh_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_set-dvh.js */ "./src/js/templates/_set-dvh.js");
/* harmony import */ var _spollers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_spollers.js */ "./src/js/templates/_spollers.js");
